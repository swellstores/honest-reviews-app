...
<body style="word-spacing:normal;">
  <div style="">
    ...
    <p>You recently purchased <a href="{{ product_url }}">{{ product.name }}</a> and we'd love to hear your feedback.</p>

    <p>Please take a moment to review your purchase here: <a href="{{ review_url }}">{{ review_url }}</a></p>
    ...
    <p>Thank you, we look forward to hearing about your purchase.</p>
  </div>
</body>
