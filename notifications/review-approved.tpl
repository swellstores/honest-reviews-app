...
<body style="word-spacing:normal;">
  <div style="">
    ...
    <p>Your {{ rating }} star review for <a href="{{ product_url }}">{{ product.name }}</a> was published!</p>

    {%- if settings.rewards.enabled and reward_amount > 0 -%}
    <p>To show our thanks, we've added {{ reward_amount | currency }} to your account to spend on future purchases.</p>
    {%- endif -%}
